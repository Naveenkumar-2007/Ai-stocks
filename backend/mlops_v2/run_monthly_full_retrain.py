...
def run_monthly_full_retrain() -> Path:
    trainer = TrainerV2()
    ...
    out_path = out_dir / "monthly_full_retrain_summary.json"
    out_path.write_text(json.dumps({"results": results}, indent=2), encoding="utf-8")
    return out_path


if __name__ == "__main__":
    report_path = run_monthly_full_retrain()
    print(f"Monthly full retrain summary: {report_path}")
